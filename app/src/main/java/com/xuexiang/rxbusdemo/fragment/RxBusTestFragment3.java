...
public class RxBusTestFragment3 extends BaseRxBusTestFragment {
    ...
    protected void initListener() {
        super.initListener();
        RxBusUtils.get().onMainThread(EventKey.EVENT_BACK_MAINTHREAD, new Action1<String>() {
            @Override
            public void call(String eventName) {
                showContent(EventKey.EVENT_BACK_MAINTHREAD, "   EventName:" + eventName + ", 当前线程状态： " + Event.getLooperStatus());
            }
        });
