...
import com.xuexiang.rxbusdemo.R;
import com.xuexiang.rxbusdemo.base.BaseFragment;
...
public abstract class BaseRxBusTestFragment extends BaseFragment {
    ...
    protected void initListener() {
        mSubscribeInfo = RxBusUtils.get().onMainThread(EventKey.EVENT_CLEAR, new Action1<String>() {
            @Override
